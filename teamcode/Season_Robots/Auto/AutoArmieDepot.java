...
@Autonomous (name = "AutoArmieDepot", group = "Armiebot_Tests_Food")
public class AutoArmieDepot extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        motorBackLeft.setPower(0);
        motorBackRight.setPower(0);
        Camera.setPosition(CP - .5);
        while (opModeIsActive() && (ResetTime.seconds() < 3) && (goldMineralX == -1)) {
        ...
        /*center();
        ResetTime.reset();
        while (opModeIsActive() && (ResetTime.seconds() < 30) && (goldMineralX != -1)) {
            telemetry.addData("Where", "Step 6: %2.5f S Elapsed", ResetTime.seconds());
            telemetry.update();
        }*/
